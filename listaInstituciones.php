...
<head>
    ...
    <title>Lista de Instituciones | SISFIN</title>
...
function go(){
    ...
    document.location.href="ingresarInstitucion.php"; 
} 
function modify(id){
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										...
										<p>Datos <span class="bread-ntd">de Instituciones</span></p>
									</div>
								</div>
							</div>
...
$result = $conexion->query("SELECT * from tinstitucion ORDER BY id_institucion");
if ($result) {
    while ($fila = $result->fetch_object()) {
        ...
        <button class='btn btn-lightgreen lightgreen-icon-notika btn-reco-mg btn-button-mg' onclick='modify(" . $fila->id_institucion. ")'><i class='notika-icon notika-menus'></i></button>
        </div>
        </td>";
        echo "</tr>";
