							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										...
										<p>Datos de personales<span class="bread-ntd"> de encargados.</span></p>
									</div>
								</div>
							</div>
...
$result = $conexion->query("SELECT * from tencargado ORDER BY id_encargado");
if ($result) {
    while ($fila = $result->fetch_object()) {
       ...
       <button class='btn btn-lightgreen lightgreen-icon-notika btn-reco-mg btn-button-mg' onclick='modify(" . $fila->id_encargado. ")'><i class='notika-icon notika-menus'></i></button>
