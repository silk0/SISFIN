...
$result = $conexion->query("select * from tencargado where id_encargado=" . $id);
if ($result) {
    while ($fila = $result->fetch_object()) {
        $idR               = $fila->id_encargado;
        $nombreR           = $fila->nombre;
...
<head>
    ...
    <title>Editar Encargados | SISFIN</title>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Modificación de datos del encargado.</h2>
										<p>Formulario de datos personales <span class="bread-ntd">para encargados.</span></p>
									</div>
								</div>
							</div>
