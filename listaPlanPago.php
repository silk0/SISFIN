...
<head>
    ...
    <title>Lista de Planes de Pago | SISFIN</title>
...
function go(){
    ...
    document.location.href="planPago.php"; 
} 
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Lista de Plan de Pago.</h2>
										<p>Datos <span class="bread-ntd">de Planes de Pago</span></p>
									</div>
								</div>
							</div>
